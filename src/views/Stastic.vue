    ...
    <v-row>
      <v-col cols="12">
        <v-data-table
          ...
          no-data-text="无可用数据"
        >
          <template v-slot:[`item.open_count`]="{ item }">
            {{ item.open_count }} 次
          </template>
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: '开机次数', value: 'open_count', align: 'center', class: 'pl-4 pr-0' },
        { text: '总能耗', value: 'total_energy', align: 'center', class: 'pl-4 pr-0' },
        { text: '总费用', value: 'total_cost', align: 'center', class: 'pl-4 pr-0' }
      ],
      loadingTable: false
    }),
